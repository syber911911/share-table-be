...
public class QUserAgentInfo extends BeanPath<UserAgentInfo> {
    ...
    private static final long serialVersionUID = -1825343375L;
    ...
    public final EnumPath<com.loadToFerrai.share_table_api.entity.enums.UserAgentType> userAgentType = createEnum("userAgentType", com.loadToFerrai.share_table_api.entity.enums.UserAgentType.class);
